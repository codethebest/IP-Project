<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JobReportsNotCompleted.aspx.cs" Inherits="Admin_Reports_Jobs_JobReportsNotCompleted" %>
        ...
        <table class="style1">
            <tr>
                <td class="style2" colspan="2">
                    Report of Jobs not completed</td>
            </tr>
            <tr>
                <td colspan="2">
                    &nbsp;</td>
            ...
            <tr>
                <td colspan="2">
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                        ...
                        SelectCommand="SELECT * FROM [Jobs] WHERE ([dateCompleted] IS NULL)">
                    </asp:SqlDataSource>
                </td>
            </tr>
            <tr>
