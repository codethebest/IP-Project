<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InvoiceReportsByJob.aspx.cs" Inherits="Admin_Reports_Invoices_InvoiceReportsByJob" %>
            ...
            <tr>
                ...
                <td>
                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                        ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                        SelectCommand="SELECT * FROM [Invoice] WHERE ([jobID] = @jobID)">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="DropDownList1" Name="jobID" 
