<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PartReportsAll.aspx.cs" Inherits="Admin_Reports_Parts_PartReportsAll" %>
...
<body>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT * FROM [Parts]"></asp:SqlDataSource>
        <br />
        <table class="style1">
            <tr>
                <td>
                    Report of all parts</td>
            </tr>
        </table>
