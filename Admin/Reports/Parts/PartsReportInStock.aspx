<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PartsReportInStock.aspx.cs" Inherits="Admin_Reports_Parts_PartsReportInStock" %>
...
<body>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        <SelectParameters>
            <asp:QueryStringParameter DefaultValue="Yes" Name="inStock" 
                QueryStringField="Yes" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
