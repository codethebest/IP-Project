<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ItemReportsNotBookedOut.aspx.cs" Inherits="Admin_Reports_Items_ItemReportsNotBookedOut" %>
...
<body>
    ...
    <div>
        ...
        <table class="style1">
            <tr>
                <td>
                    Report of Items not booked out</td>
            </tr>
            <tr>
                <td>
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                        ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                        SelectCommand="SELECT * FROM [Items] WHERE ([dateBookedOut] IS NULL)">
                    </asp:SqlDataSource>
                </td>
            </tr>
            <tr>
